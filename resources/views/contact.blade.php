...
<div class="bg-blue-100 border-t border-b border-blue-500 text-blue-700 px-4 py-3" role="alert">
    <p class="font-bold">Succesful Sending Message</p>
    <p class="text-sm">{{Session::get('msg')}}</p>
  </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 border">
        <div class="bg-gray-900 md:col-span-4 p-10 text-white">
            ...
            <p class="mt-4 leading-7 text-gray-200">
                If you need any Support or you have any question just send a message to us or call us
            </p>
            ...
            <div class="flex items-center mt-5">
                ...
                <span class="text-sm">Street 00 Vienna 1110, Austia</span>
            </div>
            <div class="flex items-center mt-5">
		...
		c0.067,0.04,6.778,4.003,8.521,7.296C52.202,48.062,51.994,49.447,51.078,50.363z">
                ...
                <span class="text-sm">+430000000</span>
            </div>
            <div class="flex items-center mt-5">
                <svg class="h-6 mr-2 text-indigo-600" fill="currentColor" version="1.1" id="Capa_1"
                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        ...
        <form class="md:col-span-8 p-10" action="{{ route('send_mail') }}" method="POST"
        ...
        @csrf
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input
                        ...
                        id="grid-first-name" type="text" name="name"  placeholder="Jane" required>
                </div>
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full px-3">
                    ...
                    <input
                        ...
                        id="grid-email" type="email" name="email" placeholder="********@*****.**" required>
                </div>
            </div>
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full px-3">
                    ...
                    <textarea rows="10"
                        class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" name="mess"></textarea>
                </div>
