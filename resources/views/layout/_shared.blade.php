...
<body >
	<nav class="relative px-4 py-4 flex justify-between items-center ">
      ...
      {{-- riemann svg --}}
            ...
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="polar_zeta_plot" version="1.1" baseProfile="full" width="97" height="97" viewBox="0 0 560 480">
                <g style="fill:none; color:rgb(177, 7, 7); stroke:rgb(0, 0, 0); stroke-width:3.00">
                  <g transform="translate(300,25)" style="stroke:none; fill:rgb(255, 255, 255); font-family:Arial; font-size:35.00; text-anchor:middle">
                    ...
                    <g transform="translate(464,350)" style="stroke:none; fill:rgb(255, 255, 255); font-family:Arial; font-size:30.00; text-anchor:start">
                      <text>Re ζ(½ + it)</text>
                    </g>
                  </g>
      ...
      {{-- riemann svg --}}
		...
		<div class="lg:hidden">
			<button class="navbar-burger flex items-center text-white font-bold p-4">
	...
	<div class="navbar-menu relative z-50 hidden">
		...
		<nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-black border-r overflow-y-auto">
           ...
           {{-- riemann svg --}}
            ...
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="polar_zeta_plot" version="1.1" baseProfile="full" width="73" height="73" viewBox="0 0 560 480">
                <g style="fill:none; color:rgb(177, 7, 7); stroke:rgb(0, 0, 0); stroke-width:3.00">
                  <g transform="translate(300,25)" style="stroke:none; fill:rgb(255, 255, 255); font-family:Arial; font-size:35.00; text-anchor:middle">
                    <text>Polar graph of Riemann zeta(½ + it)</text>
                    </g>
